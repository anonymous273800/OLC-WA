...
Total n_samples:  3900 (3 classes 100 each , this occurs 13 time shifts)
Dimensions: 2
Drift Location: 1200 | 1500 | 1800 | 2400 | 2700 | 3900
'''

def get_DS25():
    np.random.seed(42)
    n_samples_per_class = 100  # 3 classes
    drift_type = 'Gradual'
    drift_locations = [1200 , 1500 , 1800 , 2400 , 2700 , 3900]
    X1, y1 = get_mini_dataset(n_samples_per_class, mean_class_0=0.0, mean_class_1=3.0, mean_class_2=6.0)
    X2, y2 = get_mini_dataset(n_samples_per_class, mean_class_0=0.0, mean_class_1=3.0, mean_class_2=6.0)
    X3, y3 = get_mini_dataset(n_samples_per_class, mean_class_0=0.0, mean_class_1=3.0, mean_class_2=6.0)
    X4, y4 = get_mini_dataset(n_samples_per_class, mean_class_0=0.0, mean_class_1=3.0, mean_class_2=6.0)
    X_start = np.vstack((X1, X2, X3, X4))

    X5, y5 = get_mini_dataset(n_samples_per_class, mean_class_0=15.0, mean_class_1=17.0, mean_class_2=20.0)
    DriftDatasetsCharacteristics.print_drift_magnitude_consecutive(X_start, X5)

    X6, y6 = get_mini_dataset(n_samples_per_class, mean_class_0=0.0, mean_class_1=3.0, mean_class_2=6.0)
    DriftDatasetsCharacteristics.print_drift_magnitude_consecutive(X5, X6)

    X7, y7 = get_mini_dataset(n_samples_per_class, mean_class_0=15.0, mean_class_1=17.0, mean_class_2=20.0)
    X8, y8 = get_mini_dataset(n_samples_per_class, mean_class_0=15.0, mean_class_1=17.0, mean_class_2=20.0)
    X_middle = np.vstack((X7, X8))
    DriftDatasetsCharacteristics.print_drift_magnitude_consecutive(X6, X_middle)

    X9, y9 = get_mini_dataset(n_samples_per_class, mean_class_0=0.0, mean_class_1=3.0, mean_class_2=6.0)
    DriftDatasetsCharacteristics.print_drift_magnitude_consecutive(X_middle, X9)

    X10, y10 = get_mini_dataset(n_samples_per_class, mean_class_0=15.0, mean_class_1=17.0, mean_class_2=20.0)
    X11, y11 = get_mini_dataset(n_samples_per_class, mean_class_0=15.0, mean_class_1=17.0, mean_class_2=20.0)
    X12, y12 = get_mini_dataset(n_samples_per_class, mean_class_0=15.0, mean_class_1=17.0, mean_class_2=20.0)
    X13, y13 = get_mini_dataset(n_samples_per_class, mean_class_0=15.0, mean_class_1=17.0, mean_class_2=20.0)
...
def get_mini_dataset(n_samples_per_class, mean_class_0, mean_class_1,mean_class_2):
    ...
    mean_class_2 = np.array([mean_class_2, mean_class_2])  # Mean of class 1
    ...
    if plotting_enabled == True:
        ...
        plt.scatter(X_class_2[:, 0], X_class_2[:, 1], color='green', label='Class 2', alpha=0.5)
