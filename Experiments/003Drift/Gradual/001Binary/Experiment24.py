...
from Datasets.Drift.Gradual.Binary import DS24
...
def experiment23Main():
    ...
    if (plotting_enabled):
        ...
        plot_results(x_axis_olc_wa_sccm, y_axis_olc_wa_sccm, x_axis_pa, y_axis_pa,
                     ...
                     gradual_drift_locations=[8000 , 10000 , 12000 , 16000 , 18000, 26000],
...
def plot_results(x_axis_olc_wa_sccm, y_axis_olc_wa_sccm, x_axis_pa, y_axis_pa,
    ...
    line1, = plt.plot(x_axis_olc_wa_sccm, y_axis_olc_wa_sccm, linestyle='-', marker='.', markersize=2, linewidth=.9,
