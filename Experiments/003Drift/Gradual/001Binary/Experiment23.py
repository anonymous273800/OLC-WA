...
from Datasets.Drift.Gradual.Binary import DS23
from Utils import Predictions, Measures, Printer

from Utils import Plotter
warnings.filterwarnings("ignore")

def experiment23Main():
    # Abrupt Drift dataset
    X, y = DS23.get_DS23()
    n_samples, n_features = X.shape
    print(n_samples, n_features)
    train_percent = int(93.5 * n_samples / 100)
    ...
    if (plotting_enabled):
        ...
        plot_results(x_axis_olc_wa_sccm, y_axis_olc_wa_sccm, x_axis_pa, y_axis_pa,
                     ...
                     legend_loc='lower left', drift_type='gradual',
                     gradual_drift_locations=[800 , 1000 , 1200 , 1600 , 1800, 2600],
