...
def experiment001Main():
    ...
    for seed in SEEDS:
        ...
        #                                                20, #Hyperparameters.olr_wa_increment_size(n_features,
        #                                                     #                                user_defined_val=10),
        #                                                seed,
        #                                                shuffle=True
        #                                                )
    ...
    print('Online Logistic Regression, 5 folds, seeds averaging. time:', "{:.5f} s".format(online_logistic_regression_execution_time / total_runs),
          ', accuracy:',
