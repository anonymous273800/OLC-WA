...
def experiment11Main():
    ...
    for seed in SEEDS:
        ...
        # n_clusters_per_class=n_clusters_per_class, n_redundant=n_redundant, n_informative=n_informative,
        # flip_y=flip_y, class_sep=class_sep, shuffle=shuffle, random_state=seed)

        X, y = PublicDS.get_handwritten_digits_ds(seed)
