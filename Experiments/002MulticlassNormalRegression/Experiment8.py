...
def experiment9Main():
    ...
    print('OLC_WA (ovr), 5 folds, seeds averaging. time:', "{:.5f} s".format(olc_wa_execution_time / total_runs), ', accuracy:',
    ...
    print('OLC_WA (SCCM) (ovr), 5 folds, seeds averaging. time:', "{:.5f} s".format(olc_wa_sccm_execution_time / total_runs), ', accuracy:',
    ...
    print('Widrow-Hoff (OVR), 5 folds, seeds averaging. time:', "{:.5f} s".format(widrow_hoff_execution_time / total_runs),
          ', accuracy:',
