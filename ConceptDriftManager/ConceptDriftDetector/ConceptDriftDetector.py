...
class ConceptDriftDetector:
    ...
    def get_scales_map(self, result, expr):
        if expr == 'expr1':
            ranges_values = {
                (float('-inf'), result[5]): 0.08,
                (result[5], result[4]): 0.1,
                (result[4], result[3]): 0.15,
                (result[3], result[2]): 0.2,
                (result[2], result[1]): 0.25,
                (result[1], float('inf')): .35
            }
            return ranges_values
        if expr == 'expr2':
            ranges_values = {
                (float('-inf'), result[5]): 0.05,
                (result[5], result[4]): 0.05,
                (result[4], result[3]): 0.05,
                (result[3], result[2]): 0.05,
                (result[2], result[1]): 0.05,
                (result[1], float('inf')): 0.05
            }
            return ranges_values
        if expr == 'expr3':
            ranges_values = {
                (float('-inf'), result[5]): 0.22,
                (result[5], result[4]): 0.22,
                (result[4], result[3]): 0.22,
                (result[3], result[2]): 0.22,
                (result[2], result[1]): 0.22,
                (result[1], float('inf')): 0.22
            }
            return ranges_values

        if expr == 'expr4':
            ranges_values = {
                (float('-inf'), result[5]): 0.15,
                (result[5], result[4]): 0.15,
                (result[4], result[3]): 0.15,
                (result[3], result[2]): 0.15,
                (result[2], result[1]): 0.15,
                (result[1], float('inf')): 0.15
            }
            return ranges_values

        if expr == 'expr5':
            ranges_values = {
                (float('-inf'), result[5]): 0.2,
                (result[5], result[4]): 0.2,
                (result[4], result[3]): 0.2,
                (result[3], result[2]): 0.2,
                (result[2], result[1]): 0.2,
        ...
        if expr == 'expr6':
            ranges_values = {
                (float('-inf'), result[5]): 0.3,
                (result[5], result[4]): 0.3,
                (result[4], result[3]): 0.3,
                (result[3], result[2]): 0.3,
                (result[2], result[1]): 0.3,
                (result[1], float('inf')): 0.3
            }
            return ranges_values
        ...
        if expr == 'expr8':
            print("Experiment 8 here")
            ranges_values = {
                (float('-inf'), result[5]): .1,
                (result[5], result[4]): 0.2,
                (result[4], result[3]): 0.3,
                (result[3], result[2]): 0.4,
                (result[2], result[1]): 0.5,
                (result[1], float('inf')): .6
            }
            return ranges_values
        if expr == 'expr9':
            print("Experiment 9 here")
            ranges_values = {
                (float('-inf'), result[5]): .1,
                (result[5], result[4]): 0.15,
                (result[4], result[3]): 0.2,
                (result[3], result[2]): 0.25,
                (result[2], result[1]): 0.3,
                (result[1], float('inf')): .35
            }
            return ranges_values
        if expr == 'expr10':
            print("Experiment 10 here")
            ranges_values = {
                (float('-inf'), result[5]): 0.3,
                (result[5], result[4]): 0.3,
                (result[4], result[3]): 0.3,
                (result[3], result[2]): 0.3,
                (result[2], result[1]): 0.3,
                (result[1], float('inf')): .3
            }
            return ranges_values
        if expr == 'expr12':
            print("Experiment 12 here")
            ranges_values = {
                (float('-inf'), result[5]): .1,
                (result[5], result[4]): 0.1,
                (result[4], result[3]): 0.1,
                (result[3], result[2]): 0.1,
                (result[2], result[1]): 0.1,
                (result[1], float('inf')): 0.1
            }
            return ranges_values
        if expr == 'expr13': # doesn't matter if you keep it all .5 is better
            print("Experiment 13 here")
            ranges_values = {
                (float('-inf'), result[5]): .5,
                (result[5], result[4]): 0.6,
                (result[4], result[3]): 0.7,
                (result[3], result[2]): 0.8,
                (result[2], result[1]): 0.9,
                (result[1], float('inf')): 0.99
            }
            return ranges_values

        if expr == 'expr14':
            print("Experiment 15 here")
            ranges_values = {
                (float('-inf'), result[5]): 0.1,
                (result[5], result[4]): 0.2,
                (result[4], result[3]): 0.25,
                (result[3], result[2]): 0.3,
                (result[2], result[1]): 0.35,
                (result[1], float('inf')): .4
            }
            return ranges_values

        if expr == 'expr17':
            print("Experiment 17 here")
            ranges_values = {
                (float('-inf'), result[5]): 0.1,
                (result[5], result[4]): 0.2,
                (result[4], result[3]): 0.25,
                (result[3], result[2]): 0.3,
                (result[2], result[1]): 0.35,
                (result[1], float('inf')): 1
            }
            return ranges_values
        if expr == 'expr18':
            print("Experiment 18 here")
            ranges_values = {
                (float('-inf'), result[5]): 0.3,
                (result[5], result[4]): 0.5,
                (result[4], result[3]): 0.5,
                (result[3], result[2]): 0.6,
                (result[2], result[1]): 0.6,
                (result[1], float('inf')): 1
            }
            return ranges_values
        if expr == 'expr19':
            print("Experiment 19 here")
            ranges_values = {
                (float('-inf'), result[5]): .5,
                (result[5], result[4]): .6,
                (result[4], result[3]): .7,
        ...
        if expr == 'expr21':
            ...
            # return ranges_values
            ranges_values = {
                (float('-inf'), result[5]): .6,
                (result[5], result[4]): .7,
                (result[4], result[3]): .8,
                (result[3], result[2]): .9,
                (result[2], result[1]): .99,
                (result[1], float('inf')): 1
            }
            return ranges_values
        else: # 15 works here
            print('expr ', expr, 'works here')
            ranges_values = {
                (float('-inf'), result[5]): 0.9,
                (result[5], result[4]): 0.9,
                (result[4], result[3]): 0.9,
                (result[3], result[2]): 0.95,
                (result[2], result[1]): 0.99,
                (result[1], float('inf')): 1
            }
        return ranges_values
    ...
    def get_scales_map_expr2(self, result):
        ranges_values = {
            (float('-inf'), result[5]): 0.05,
            (result[5], result[4]): 0.05,
            (result[4], result[3]): 0.05,
    ...
    def get_scales_map_expr3(self, result):
        ranges_values = {
            (float('-inf'), result[5]): 0.22,
            (result[5], result[4]): 0.22,
            (result[4], result[3]): 0.22,
    ...
    def get_scales_map_expr4(self, result):
        ranges_values = {
            (float('-inf'), result[5]): 0.15,
            (result[5], result[4]): 0.15,
            (result[4], result[3]): 0.15,
    ...
    def get_scales_map_expr5(self, result):
        ranges_values = {
            (float('-inf'), result[5]): 0.2,
            (result[5], result[4]): 0.2,
            (result[4], result[3]): 0.2,
    ...
    def get_scales_map_expr6(self, result):
        ranges_values = {
            (float('-inf'), result[5]): 0.3,
            (result[5], result[4]): 0.3,
            (result[4], result[3]): 0.3,
    ...
    def get_scales_map_expr7(self, result):
        ranges_values = {
            (float('-inf'), result[5]): 0.2,
            (result[5], result[4]): 0.2,
            (result[4], result[3]): 0.2,
    ...
    def get_KPI_Window_ST(self, mini_batch_data, KPI):
        KPI_Window = np.array([])
        mini_batch_data_amended = mini_batch_data[-7:]
        if KPI == 'R2':
            ...
            KPI_Window = np.concatenate([np.array([data.get_acc()]) for data in mini_batch_data_amended])
    ...
    def get_KPI_Window_LT(self, mini_batch_data, KPI):
        ...
        if KPI == 'R2':
            ...
            KPI_Window = np.concatenate([np.array([data.get_acc()]) for data in mini_batch_data])
